...
var game = {
    ...
    //Start initialiing objects, preloading assets and displa start screen
    init: function() {
        //Initialize objects
        levels.init();
        //Listing 2-11
        ...
        //Hide all game layers and displa the start screen
        $('.gamelayer').hide();
    ...
    //4-16 Handling the load-next-hero State        
    ...
    handlePanning: function() {
        //Listing 2-14
        //game.offsetLeft++; //Temporaty placeholder - keep panning to the right
        ...
        //4-22 Implementing the Level Ending States
...
//Listing 2-5 Simple levels Object with Level Data and Funtions
var levels = {
    //Level data
    data: [
        {
            ...
            entities: [
                ...
                {type: "block", name: "wood", x: 620, y: 370, angle: 90, width: 100, height: 25},
        ...
        {//Second level
            ...
            entities: [
                //Listing 4-8
                {type: "ground", name: "dirt", x: 500, y: 440, width: 1000, height: 20, isStatic: true},
                {type: "ground", name: "wood", x: 180, y: 390, width: 50, height: 80, isStatic: true},
    ...
    //Initializa level selection screen
    init: function() {
        var html = "";
    ...
    load: function(number) {
        ...
        // Call game.start() once the assets are loaded
        if (loader.loaded) {
            game.start();
        } else {
        ...
        switch (entity.type) {
            ...
            case "hero":
               if (entity.shape == "circle") {
                ...
                break;
            case "ground":
                //do donthing... We will draw objects like the ground & slingshot separately
                break;
        }
...
//Listing 4-6 Creating a box23 Object
var box2d = {
    scale: 30,
    init: function() {
...
var loader = {
    ...
    totalCount: 0, //Total number of asstes that need to be loaded
